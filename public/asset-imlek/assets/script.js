$(document).ready(function() {
    audioClick = new Audio('/asset-imlek/assets/sound/buttonclikc.mp3');
    audioHover = new Audio('/asset-imlek/assets/sound/hover-button.mp3');
...
$(document).ready(function () {
    ...
    audioRandom = new Audio('/asset-imlek/assets/sound/swapcard.mp3');
    audioBarongsai = new Audio('/asset-imlek/assets/sound/barongsai.mp3');
    audioYee = new Audio('/asset-imlek/assets/sound/yee.mp3');
    audioNoo = new Audio('/asset-imlek/assets/sound/noo.mp3');
    audioDrum = new Audio('/asset-imlek/assets/sound/drumroll.mp3');
    audioDrum.volume = 0.5;
    var audioKlik = document.createElement("audio");
    audioKlik.src = '/asset-imlek/assets/sound/backsound.mp3';
        ...
        $('.forelist').click(function () {
            ...
            if (!forelistClicked) {
                ...
                setTimeout(function () {
                    ...
                    if (savedValue === 'zonk!') {
                        audioNoo.play();
                        $('.grouppop img').attr('src', '/asset-imlek/asset-imlek/assets/img/popup_angpao-zonk2024S.png');
                    } else {
                        audioYee.play();
                    }
                    $('.popuphasilinvo').css({
