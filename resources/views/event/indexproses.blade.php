            ...
            <tbody>
                ...
                @foreach ($data as $index => $d)
                    <tr>
                        ...
                        <td>
                            @if ($jenis_event)
                                <span class="name hadiah-event">{{ $d['hadiah'] }}</span>
                            @else
                                <span class="name">
                                    {{ $d['url_spinner'] }}
    ...
    <script>
        $(document).ready(function() {
            $('#search_website').change(function(event) {
                ...
                window.location.href = '/prosesevent/indexproses/' + jenis_event + '/' + website;
            });
        });
                        ...
                        if (result.errors) {
                            ...
                            if (status == '1') {
                                Swal.fire({
                                    ...
                                    window.location.href = '/prosesevent/indexproses/' +
                                        jenis_event + '/' + website;
                                });
                            } else {
                                Swal.fire({
