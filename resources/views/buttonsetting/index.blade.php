...
@section('container')
    ...
    <div class="sec_table">
        ...
        <div class="group_act_butt">
            <a href="/buttonsetting/add" id="add-buttonsetting">
            ...
            <div class="all_act_butt">
                <a href="#" id="update-buttonsetting">
                    <div class="sec_edit">
                ...
                {{-- <a href="#" id="delete-buttonsetting">
                    ...
                    <tr>
                        ...
                        <td class="kolom_action">
                            ...
                            <div class="action_crud" id="1" style="display: none;">
                                <a href="/buttonsetting/view/{{ $d['id'] }}">
                                ...
                                <a href="/buttonsetting/edit/{{ $d['id'] }}" id="edit">
                                    <div class="list_action">
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('#update-buttonsetting').off('click').click(function(event) {
                ...
                window.location.href = '/buttonsetting/edit/' + parameterString;
            });
            ...
            //     event.preventDefault();
            //     $('.aplay_code').load('/buttonsetting/delete', function() {
            //         adjustElementSize();
            //         localStorage.setItem('lastPage', '/buttonsetting/delete');
            //     });
            // })



            $(document).on('click', '#delete-buttonsetting', function(event) {
                event.preventDefault();
                ...
                var url =
                    "/buttonsetting/delete/"; // Ubah URL sesuai dengan endpoint delete yang sesuai
