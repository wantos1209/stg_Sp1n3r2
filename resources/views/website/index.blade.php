...
@section('container')
    ...
    <div class="sec_table">
        ...
        <div class="group_act_butt">
            <a href="/website/add" id="add-website">
            ...
            <tbody>
                ...
                @foreach ($data as $index => $d)
                    <tr>
                        ...
                        <td><span class="name">{{ $d['livechat'] }}</span></td>
                        <td><span class="name">{{ $d['whatsapp'] }}</span></td>
                        ...
                        <td class="kolom_action">
                            ...
                            <div class="action_crud" id="1" style="display: none;">
                                <a href="/website/view/{{ $d['id'] }}" id="view">
                                ...
                                <a href="/website/edit/{{ $d['id'] }}" id="edit">
                                    <div class="list_action">
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('#update-website').off('click').click(function(event) {
                ...
                window.location.href = '/website/index/' + parameterString;
            });
            ...
            //     event.preventDefault();
            //     $('.aplay_code').load('/website/delete', function() {
            //         adjustElementSize();
            //         localStorage.setItem('lastPage', '/website/delete');
            //     });
            // })
            ...
            $(document).on('click', '#delete-website', function(event) {
                ...
                var url =
                    "/website/delete/"; // Ubah URL sesuai dengan endpoint delete yang sesuai
