...
Route::middleware(['isAdmin'])->group(function () {
    ...
    Route::get('/urlevent/view/{id}', [UrlEventController::class, 'view']);
    ...
    /* buttonSetting */
    Route::get('/buttonsetting/index/', [ButtonSettingController::class, 'index']);
    Route::get('/buttonsetting/add/', [ButtonSettingController::class, 'create']);
    Route::get('/buttonsetting/edit/{id}', [ButtonSettingController::class, 'edit']);
    Route::get('/buttonsetting/view/{id}', [ButtonSettingController::class, 'view']);
    Route::post('/buttonsetting/update/', [ButtonSettingController::class, 'update']);
...
/* Front NewYear */
Route::get('/l21newyear/{jenis_event}/{website}/{deviceid}/{ip?}', [NewYearController::class, 'l21newyear']);
